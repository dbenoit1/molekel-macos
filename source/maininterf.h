...
extern GLUI *mainglui_top, *maiglui_bottom, *infoglui;
extern int maininterfwin;
extern int molprop_live_var;
extern char active_mol_nbr[];
extern char active_mol_name[];
extern char logstack[50][30];

void maininterf(void);
void update_logs(void);
void logstring(int x, int y, char *string);
void logprint(char *string);
void showinfobox(char *string);
