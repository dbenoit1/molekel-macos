...
extern GLUI *surfaceglui;
extern GLUI *surf_optglui;
extern GLUI *planeglui;
extern GLUI_StaticText *Vmintext, *Vmaxtext;
extern GLUI_Rotation *rot;
extern GLUI_Translation *trans;
extern GLUI_RadioGroup *format_rbgrp;
extern int clip_move_rot;
extern int clipplane_moving;
