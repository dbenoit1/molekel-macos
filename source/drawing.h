...
extern int drawingtime;
extern float  scale_factor;
extern float sfac;
extern float t[3], r[4], s;
extern float spinrot[4];
extern float global_trans[3], global_rot[4];
extern float global_center[3], global_scale;
extern float global_spin[4];
extern short rapidmove;
extern unsigned long backcolor1, backcolor2;
extern float distcolor[4], anglecolor[4], dihedcolor[4], \
             labelcolor[4];
extern int halftone_pattern;
...
void draw_back(void);
void show_freq_arrow(Vibration *vib);
