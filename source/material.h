...
extern GLuint def_mat_base;
extern GLuint element_mat_base;
extern GLuint surface_mat_base;
extern GLuint bond_mat;
extern GLuint arrow_mat;
extern GLuint pick_mat;
extern GLuint box_mat;
extern GLuint line_style_base;
extern GLubyte halftone1[];
extern GLubyte halftone2[];
extern GLubyte halftone3[];
extern GLubyte halftone4[];
extern GLubyte halftone5[];
extern GLubyte halftone6[];
